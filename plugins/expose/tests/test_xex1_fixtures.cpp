...
std::vector<FrameV2> build_frames_v2() {
...

    {
        ...
        FrameV2 f; f.name = "v2_bool"; f.channel = "c"; f.seq = 9;
        {V2Field fl; fl.key = "pass"; fl.kind = "bool"; fl.b = true;  f.fields.push_back(fl);}
        {V2Field fl; fl.key = "fail"; fl.kind = "bool"; fl.b = false; f.fields.push_back(fl);}
