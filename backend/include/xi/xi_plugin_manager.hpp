...
#include "xi_project_model.hpp" // ProjectInfo / InstanceInfo / CompileEnv (data model)
...
// InstanceInfo / ProjectInfo (+ DispatchGroup) / CompileEnv moved to
// xi_project_model.hpp (included above).
