...
// the script and recompiles on save. VAR() and xi::use() work here because this
// compiles as part of inspect.cpp's translation unit, NOT as a separate object.
//
#include <xi/xi.hpp>
...
inline void run_lane_a(int frame) {
    VAR(lane_a_frame, frame);
    VAR(lane_a_tag, std::string("alpha"));
