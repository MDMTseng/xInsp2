...
// frame, and asserts the "script" VAR == 2 (i.e. THIS file compiled, not the
// project.json default inspect.cpp which stamps 1).
//
#include <xi/xi.hpp>
...
void xi_inspect_entry(int frame) {
    ...
    VAR(script, 2);   // override-script marker (default inspect.cpp emits 1)
}
