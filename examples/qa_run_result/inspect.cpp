...
// then ok1 (+1), then ng2 (-2). Also tries to set a reserved system code — the
// xi::result header must clamp it to -1 (user can't squat the framework band).
#include <xi/xi.hpp>
...
void xi_inspect_entry(int /*frame*/) {
    ...
    switch (n++ % 4) {
        ...
        case 3: xi::result(-999001, "trying to squat XI_SYS_DROPPED");       break;  // -> clamped to -1
    }
}
