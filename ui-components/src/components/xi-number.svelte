...
<style>
  .xi-number { display: inline-flex; align-items: center; gap: 0.5rem; font: 13px system-ui, sans-serif; color: var(--xi-fg, inherit); }
  input { width: 6em; padding: 0.15rem 0.3rem; accent-color: var(--xi-accent, #3b82f6); }
</style>
