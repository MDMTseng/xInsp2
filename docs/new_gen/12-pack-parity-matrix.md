...
| Status | Rows | Count |
|---|---|---|
| **GREEN (pack-only, live-service QA evidence)** | A1–A9, B1, B2, C1, C2, C4, D1, D2, G1, G3 (U2 resolved 2026-07-03) | **18** |
...
shape) gated the CUT, not P2 — and is **RESOLVED** (see §Unscheduled, row G3).
