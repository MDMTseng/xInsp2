...
| 14 | [`14-lib-plugin-capability-plane.md`](./14-lib-plugin-capability-plane.md) | Design note (unscheduled): lib plugins as host-forwarded capability providers — shared heavy services (e.g. dedup JPEG encode) register capabilities the host forwards to via the pack-door funnel with a reentrancy guard; sizing doctrine: heavy work only, light work inlines, private side-channels off-pattern; provider-registration slot rides v12 |
